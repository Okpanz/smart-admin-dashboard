...
export function EnrollmentDetailsModal({ isOpen, onClose, enrollment, onUpdateStatus }: EnrollmentDetailsModalProps) {
    ...
    const handleStatusUpdate = async (status: 'verified' | 'rejected') => {
        try {
            setProcessing(true);
            await api.patch(`/mobile/v1/enrollments/${enrollment._id}/status`, { status });
            onUpdateStatus(enrollment._id, status);
                    ...
                    <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4 border-b border-gray-200">
                        ...
                        <div className="mt-6 flex space-x-8 border-b border-gray-200">
                            <button
                                ...
                                className={`pb-4 px-1 text-sm font-medium border-b-2 ${activeTab === 'overview'
                            ...
                            <button
                                ...
                                className={`pb-4 px-1 text-sm font-medium border-b-2 ${activeTab === 'documents'
                                    ? 'border-primary-500 text-primary-600'
                                    : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'
                                    }`}
                            >
                            ...
                            <button
                                ...
                                className={`pb-4 px-1 text-sm font-medium border-b-2 ${activeTab === 'audit'
                                    ? 'border-primary-500 text-primary-600'
                                    : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'
                                    }`}
                            >
                                    ...
                                    <div>
                                        ...
                                        <div className="bg-gray-50 rounded-lg p-4 space-y-3">
                                            <div className="flex items-center justify-between">
                                                ...
                                                <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${enrollment.biometrics?.images?.length > 0 ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'
                                                    }`}>
                                            ...
                                            <div className="flex items-center justify-between">
                                                ...
                                                <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${enrollment.biometrics?.fingerprints?.length > 0 ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'
                                                    }`}>
